...
namespace SWP391_Project.Data.Databases.DiamondSystem
{
    public class DiamondContext : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer("server=34.176.180.127;database=SWP391_DiamondSystem;uid=sa;;pwd=<YourStrong@Passw0rd>;TrustServerCertificate=True;MultipleActiveResultSets=True");
        }
