    ...
    public class ApplicationMapper : Profile
    {
        public ApplicationMapper()
        {
            ...
            CreateMap<ServiceModel, Service>()
                //.ForMember(x=>x.ServiceDetails,otp=>otp.MapFrom(x=>x.ServiceDetails))
                .ReverseMap();
            CreateMap<ServiceDetailModel, ServiceDetail>()
                .ForPath(x => x.Service.Name, otp => otp.MapFrom(x => x.ServiceName))
                .ReverseMap();
            ...
            CreateMap<OrderDetail, OrderDetailGeneralResponse>()
                ...
                .ForMember(_ => _.ServiceName, opt => opt.MapFrom(_ => _.ServiceName))
